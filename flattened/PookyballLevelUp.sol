...
pragma solidity ^0.8.0 ^0.8.17 ^0.8.21 ^0.8.22 ^0.8.4;
...
// lib/openzeppelin-contracts/contracts\token/ERC20/IERC20.sol
...
abstract contract LevelUp is OwnableRoles, Signer, Treasury {
...
// src\pookyball\PookyballLevelUp.sol
...
contract PookyballLevelUp is LevelUp {
  ...
  constructor(IPookyball _pookyball, IPOK _pok, address admin, address _signer, address _treasury)
    LevelUp(_pok, admin, _signer, _treasury, 60e18, 120)
  {
